...
/**
 * 处理参数
 * @param {Array} argv arguments array, see #exports.process
 * @param {Object} options Option object
 * @param {Object} fs fs module
 * @param {Object} path path module
 * @returns {*} 返回各种解析后的配置对象
 */
...
// parse the arguments came fron command line
...
// execute karma start command then we do this
...
exports.process = function() {
    // About process.argv, See:
    // http://nodejs.org/api/process.html#process_process_argv
    // console.log(process.argv); will return
    // [ 'node', '/usr/local/bin/karma', 'start' ]
    // or [ 'node', '/usr/local/bin/karma', '--help' ]
    var argv = optimist.parse(argsBeforeDoubleDash(process.argv.slice(2)));
    // console.log(argv); returns like :
    // { _: [], version: true, '$0': 'karma' }
    // console.log(argv._); returns sth like: [ 'start' ]
    // or just [] for 'karma --help'
    var options = {
        cmd: argv._.shift()
    };
